...
namespace FrozenAge.Items.Weapons.MagicMissiles
{
	public class SpiritMissile : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shoot = ModContent.ProjectileType<SpiritMissileHead>();
			item.shootSpeed = 10f;
		}
		...
		/*public override void AddRecipes() {
			...
			recipe.AddIngredient(mod.ItemType("RottenFrostMissile"), 1);
	...
	public class SpiritMissileHead : ModProjectile
	{
		...
		{
            Projectile.NewProjectile(projectile.position.X, projectile.position.Y, 0, 0, ModContent.ProjectileType<Projectiles.FrostBlast>(), (int) (projectile.damage * 1), projectile.knockBack, Main.myPlayer);
            Projectile.NewProjectile(projectile.position.X, projectile.position.Y, 0, 0, ModContent.ProjectileType<Projectiles.FrostSoul>(), (int) (projectile.damage * 1.5), projectile.knockBack, Main.myPlayer);
		}
	}
}