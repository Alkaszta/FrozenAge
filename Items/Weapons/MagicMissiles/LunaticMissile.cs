...
namespace FrozenAge.Items.Weapons.MagicMissiles
{
	public class LunaticMissile : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shoot = ModContent.ProjectileType<LunaticMissileHead>();
			item.shootSpeed = 10f;
		}
	...
	public class LunaticMissileHead : ModProjectile
	{
		...
		public override void Kill(int timeLeft) {
            Projectile.NewProjectile(projectile.position.X, projectile.position.Y, 0, 0, ModContent.ProjectileType<Projectiles.FrostBlast>(), (int) (projectile.damage * 1.5), projectile.knockBack, Main.myPlayer);
            Projectile.NewProjectile(projectile.position.X, projectile.position.Y, 0, 0, ModContent.ProjectileType<Projectiles.FrostSoul>(), (int) (projectile.damage * 2), projectile.knockBack, Main.myPlayer);
		}
	}
}